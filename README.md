...
FluxAI is built as a monorepo with a clear separation of concerns:
...
FluxAI's workflow orchestration enables powerful agentic capabilities through a modular, step-by-step approach. Here's how to create a research agent:
...
## Local Storage
FluxAI prioritizes user privacy by storing all data locally
